# terminal-workbench-brave

> **Moved.** This project now lives in the
> [terminal-workbench-suite](https://github.com/Real-Fruit-Snacks/terminal-workbench-suite/tree/main/ports/brave) monorepo, at `ports/brave/`.
>
